...
AddEventHandler("QBCore:Client:OnPlayerLoaded", function()
    ...
    TriggerEvent('qb-hud:toggleHud',PlayerData.metadata["fitbit"].hud)
    TriggerEvent('qb-hud:toggleCompass',PlayerData.metadata["fitbit"].compass)
end)
...
RegisterNUICallback('setFoodWarning', function(data)
    ...
    QBCore.Functions.Notify('Fitbit: Food warning set at '..foodValue..'%')
end)
...
RegisterNUICallback('setThirstWarning', function(data)
    ...
    QBCore.Functions.Notify('Fitbit: Thirst warning set at '..thirstValue..'%')
end)
...
RegisterNUICallback('toggleCompass', function(data)
    ...
    TriggerEvent('qb-hud:toggleCompass',data.value)
    TriggerServerEvent('qb-fitbit:server:setValue', 'compass', compassToggle)
    if compassToggle then
        QBCore.Functions.Notify('Fitbit: Compass has been enabled')
    else
        QBCore.Functions.Notify('Fitbit: Compass has been disabled')
    end
end)

RegisterNUICallback('toggleHud', function(data)
    hudToggle = data.value
    TriggerEvent('qb-hud:toggleHud',data.value)
    TriggerServerEvent('qb-fitbit:server:setValue', 'hud', hudToggle)
    if hudToggle then
        QBCore.Functions.Notify('Fitbit: Hud has been enabled')
    else
        QBCore.Functions.Notify('Fitbit: Hud has been disabled')
    end
end)
